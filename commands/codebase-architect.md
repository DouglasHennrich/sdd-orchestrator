...
> **Prerequisite:** `.codebase/graph.json` must exist (run `/speckit.sdd-orchestrator.codebase-index` first).
> This command is normally invoked automatically by `speckit.sdd-orchestrator.specify` (Phase 0).
