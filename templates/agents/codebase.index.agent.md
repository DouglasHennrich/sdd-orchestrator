---
description: "Phase -1 — Repository Knowledge Base. Builds or refreshes the persistent codebase graph (.codebase/graph.json + .codebase/knowledge-base.md). Run automatically before speckit.specify when the graph is stale or missing."
---
